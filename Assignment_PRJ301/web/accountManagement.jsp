                ...
                <c:if test="${not empty requestScope.selectedUser}">
                    <div class="form-container">
                        ...
                        <form action="account" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="password" value="" placeholder="Enter new password (leave blank to keep)" >
                            ...
                            <input type="text" name="phone" value="${requestScope.selectedUser.phone}">
