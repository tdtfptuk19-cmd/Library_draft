        ...
        <main class="content">
            ...
            <section class="profile-info">
                ...
                <form action="profile" method="post" class="update-form">
                    ...
                    <input type="text" name="fullname" id="fullname" value="${sessionScope.user.fullname}" required><br>
                    <label for="email">Email:</label>
                    <input type="email" name="email" id="email" value="${sessionScope.user.email}" required><br>
                    <label for="phone">Phone:</label>
                    <input type="text" name="phone" id="phone" value="${sessionScope.user.phone}"><br>
